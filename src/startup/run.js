...
export async function main(ns) {
  ...
  const bn = await fetch(ns, `ns.getBitNodeMultipliers()`, '/Temp/bitnode.txt') //need SF 5
  // const bn = { // if you dont have SF 5 or are in Bitnode 5, uncomment this and modiefy these variables. These are from Bitnode 1 and work from the beginning
